              ...
              <div className="flex-1 flex items-center justify-center  sm:justify-start">
                <div className="flex-shrink-0 flex items-center">
                  <img
                    ...
                    src="https://res.cloudinary.com/yongstalee/image/upload/v1644957050/portfolio/Untitled_tqkpj0.svg"
                    alt="YHLee"
                  />
                  <img
                    className="hidden lg:block h-20 w-auto"
                    src="https://res.cloudinary.com/yongstalee/image/upload/v1644957050/portfolio/yhl_svg1_szqdrk.svg"
                    alt="YHLee"
                  />
                </div>
